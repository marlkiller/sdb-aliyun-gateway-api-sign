...
public class Sign {
    ...
    static {
        //TODO：修改为自己的密钥组合
        signSecretMap.put("123456", "123456789");
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        headers.put(CA_PROXY_SIGN, "tZi2Ucc3WWNJu2QXlUq1giqXbtjFeyzBWE3iy1CkWrE=");
        headers.put(CA_PROXY_SIGN_HEADERS, "Accept-Encoding,CaClientIp,CaDomain,CaRequestId,X-Ca-Proxy-Signature-Secret-Key,x-ca-nonce");//注意此处设置的是Demo,实际运行时,参与签名的Header需要从X-Ca-Proxy-Signature-Headers动态读取
        headers.put(CA_PROXY_SIGN_SECRET_KEY, "123456");
        headers.put("Accept-Encoding", "gzip,deflate");
        headers.put("CaClientIp", "47.74.203.115");
        headers.put("CaRequestId", "409CF7FB-8D31-4717-B8C8-DA268BD7E983");
        headers.put("x-ca-nonce", "8e5f1009-905f-4dab-bf3e-2443e0c64ce7");
        headers.put("CaDomain", "4e99dc00a9e345fc9c754d95c4eb1ca1-cn-hangzhou.alicloudapi.com");

...
public class Demo_StoreTrack_API_Group {
    ...
    static{
        ...
        HttpApiClient_StoreTrack_API_Group.getInstance().init(httpParam);
        ...
        */
        ...
        HttpsApiClient_StoreTrack_API_Group.getInstance().init(httpsParam);


    }


    public static void storeTrackApiHttpsTest(){
        HttpsApiClient_StoreTrack_API_Group.getInstance().store_track_api("test" , new ApiCallback() {
            @Override
    ...
    public static void storeTrackApiHttpTest(){
        HttpApiClient_StoreTrack_API_Group.getInstance().store_track_api("test" , new ApiCallback() {
            @Override
            public void onFailure(ApiRequest request, Exception e) {
                e.printStackTrace();
            }
    ...
    public static void store_track_apiHttpsSyncTest(){
        ApiResponse response = HttpsApiClient_StoreTrack_API_Group.getInstance().store_track_api_syncMode("test");
        try {
            System.out.println(getResultString(response));
        }catch (Exception ex){
            ex.printStackTrace();

...
public class HttpApiClient_StoreTrack_API_Group extends ApacheHttpClient{
    public final static String HOST = "storetrack-api.ikea.cn";
    static HttpApiClient_StoreTrack_API_Group instance = new HttpApiClient_StoreTrack_API_Group();
    public static HttpApiClient_StoreTrack_API_Group getInstance(){return instance;}
